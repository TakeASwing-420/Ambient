...
const Home: FC = () => {
  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto mt-20 bg-purple-50 min-h-screen h-fit home">
        {/* Hero */}
        <section className="pb-12 flex justify-center items-center min-h-[75vh] h-fit md:flex-row flex-col hero px-8 mask-clip-path">

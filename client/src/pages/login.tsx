            ...
            <section className="text-center w-full flex flex-col justify-center items-center">
              ...
              <form action="POST" className="h-fit w-[38%] bg-white shadow-2xl flex flex-col justify-center items-center px-3 py-6 rounded-xl">
                ...
                <div className="flex gap-2 justify-start w-4/5 my-2">
                    ...
                    <label htmlFor="agreement" className="text-xs">Remember Me</label>
                </div>
    
                <div className="flex gap-2 justify-end w-4/5 mt-2">
                    <Link href="/login" className="text-sm subText hover:text-purple-600">Forgot Password?</Link>
                </div>
    
                <div className="flex gap-2 justify-center w-4/5 items-center mb-1 mt-2">
                    <button className="darkBtn w-full rounded-md py-1">Log In to Vibe</button>
                </div>

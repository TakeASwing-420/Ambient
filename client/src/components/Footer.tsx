      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between">
          ...
          <div className="flex justify-center md:justify-end space-x-6 mt-4 md:mt-0">
            ...
            <a href="#" className="text-gray-400 hover:text-purple-600 text-sm">Terms of Service</a>
            <a href="#" className="text-gray-400 hover:text-purple-600 text-sm">Contact Us</a>
          </div>
        </div>
      </div>
    </footer>
